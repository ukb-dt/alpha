...
According to the Electricity Regulatory Authority (Uganda) in its Q2 2024 update, Uganda’s installed electricity generation capacity stood at **2,048.1 MW**. ([era.go.ug][1])
Note: This includes all generation – hydro, thermal, renewables.
...
* Installed capacity ≈ **2,048 MW** (Q2 2024)
* Peak consumption/demand ≈ **~1,000 MW** (with one higher estimate ~1,176 MW)
* That implies Uganda currently has a generation capacity *surplus* relative to its peak demand — though of course “capacity” doesn’t always mean “usable” (maintenance, transmission/distribution losses, etc reduce the effective delivered power).
...
**2,000 MW continuous**
Uganda’s peak demand is **~1,000–1,200 MW**.

So:

**Uganda’s entire peak load ≈ 0.5–0.6 of a single 2 GW AI site.**
...
**Uganda’s actual delivered load ≈ 10–20% of an Anthropic-scale multi-site footprint.**
...
* **Uganda ≈ N = 7.5**
* **One 2 GW campus ≈ N = 8**
* **A cluster of 4 campuses ≈ N = 9**
* **Nation-scale multi-tens-of-GW systems → N = 10+**
...
- Big Tech increases tied to AI:
  - Microsoft: +34% (2021–2022) then +22%, largely from OpenAI partnership.
  - Google: +20% then +17%.
  - Meta: Smaller but rising.
- By 2028–2030 projections: U.S. direct consumption could 2–4× to 70–140 billion gallons/year; global AI-related could hit 4–7 trillion liters/year (including indirect).

Per-query examples (highly variable by location/efficiency):
- ChatGPT-style conversation (10–50 prompts): ~500 ml total water (mostly indirect).
...
- IT load: ~2 GW (but total facility power ~2.6–2.8 GW with PUE 1.3–1.4).
- WUE: 0.8–2.0 L/kWh (lower end if optimized; higher in hot/dry climates).
...
- **The New Paradigm (Foundry):** Own physical power plants. Optimize for joules per FLOP and liters per kWh. The bottleneck is **sovereign access to fundamental resources: electrons and molecules (H₂O)**.
